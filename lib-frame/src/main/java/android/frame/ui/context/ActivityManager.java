...
public class ActivityManager {
    ...
    public static boolean isRunInBackground() {
        ...
        android.app.ActivityManager appActivityManager = LifeCycle.comp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static List<RunningTaskInfo> getRunningTask(int taskCount) {
        ...
        if (taskCount > 0) {
            android.app.ActivityManager activityManager = LifeCycle.comp().getSystemService(Context.ACTIVITY_SERVICE);
