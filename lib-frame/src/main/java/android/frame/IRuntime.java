...
import android.frame.config.AppConfigure;
import android.frame.config.RuntimeConfigure;
import android.frame.module.FilePath;
import android.frame.sign.Sign;
import android.frame.sign.SortSign;
import android.frame.ui.Shape;
...
import static android.frame.lifecycle.LifeCycle.comp;
...
public final class IRuntime {
    ...
    public static void initEnvironmentVariables() {
        String packageName = comp().app().getPackageName();
    ...
    public static void initAppFile() {
        if (FilePath.tryMKDirs()) {
            ...
            comp().app().startActivity(errorIntent);
    ...
    public static ApplicationInfo getApplicationInfo(String packageName) {
        ...
        try {
            if (Assert.notEmpty(packageName)) {
                appInfo = comp().app().getPackageManager().getApplicationInfo(packageName, GET_META_DATA);
            }
        } catch (Exception e) {
            Log.d(TAG, e);
        }
    ...
    public static boolean checkStoragePermissions() {
        ...
        if (Build.VERSION.SDK_INT >= Android.M) {
            int writeExternalStorage = PermissionChecker.checkSelfPermission(comp().app(), WRITE_EXTERNAL_STORAGE);
            int readExternalStorage = PermissionChecker.checkSelfPermission(comp().app(), READ_EXTERNAL_STORAGE);
    ...
    public static String getTopActivityName() {
        ...
        ActivityManager activityManager = comp().getSystemService(android.content.Context.ACTIVITY_SERVICE);
...
//        return false;
        ...
        ActivityManager am = comp().getSystemService(Context.ACTIVITY_SERVICE);
        List<RunningAppProcessInfo> processes = am.getRunningAppProcesses();
        if (processes == null) return false;
    ...
    public static String getLaunchActivityClassName() {
        ...
        PackageManager packageManager = comp().app().getPackageManager();
    ...
    public static int getTargetSdkVersion() {
        ...
        return comp().app().getApplicationInfo().targetSdkVersion;
    }
    ...
    public static String getProcessName() {
        ...
        ActivityManager mActivityManager = comp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static String uuid() {
        ...
        final Setting setting = comp().setting();
