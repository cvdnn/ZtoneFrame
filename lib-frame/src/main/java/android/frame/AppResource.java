...
import android.frame.lifecycle.LifeCycle;
...
public final class AppResource {
    ...
    public static int getTouchSlop() {
        ...
        return ViewConfiguration.get(LifeCycle.comp().app()).getScaledTouchSlop();
    }

    public static DisplayMetrics getDisplayMetrics() {

        return LifeCycle.comp().app().getResources().getDisplayMetrics();
    }

    public static float getDensity() {

        return LifeCycle.comp().app().getResources().getDisplayMetrics().density;
    }

    public static int getDensityDpi() {

        return LifeCycle.comp().app().getResources().getDisplayMetrics().densityDpi;
    }

    public static Resources getResources() {

        return LifeCycle.comp().app().getResources();
    }
    ...
    public static View inflate(@LayoutRes int resId) {
        ...
        if (resId != 0) {
            view = View.inflate(LifeCycle.comp().app(), resId, null);
        }
